...
const config: Config = {
  ...
  baseUrl: "/docusaurus_documentation/",

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: "QalbeAli", // Usually your GitHub org/user name.
  projectName: "docusaurus_documentation", // Usually your repo name.
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/QalbeAli/docusaurus_documentation",
        },
        blog: {
